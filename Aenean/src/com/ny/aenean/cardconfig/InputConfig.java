...
public class InputConfig {
	...
	public class GameState{
		...
		public static final int GAMEREADY = 11;		// 카드를 받기전 대기 상태
		...
		public static final int WINNERPLAERY = 15;	// 플레이어 승리
		public static final int WINNERDEALER = 16;	// 딜러 승리
		public static final int GAMEDEALING = 17;	// 초반 2장씩 나눠주고 있는 상태.
		public static final int GAMEPUSH = 18;		// 무승부
