...
public class ScoreServiceV1 {
	 ...
	 * -------------------------------------------------
	 */
	public void printScore(List<ScoreDto> stList) {
		System.out.println("=".repeat(60));
		System.out.println("학번\t국어\t수학\t음악\t미술\t총점");
		System.out.println("-".repeat(60));
		for(int i = 0; i < stList.size(); i++) {
			System.out.print(stList.get(i).getStNum() + "\t");
			System.out.print(stList.get(i).getScKor() + "\t");
			System.out.print(stList.get(i).getScMath() + "\t");
			System.out.print(stList.get(i).getScMusic() + "\t");
			System.out.print(stList.get(i).getScArt() + "\t");
			System.out.print(stList.get(i).getTotal() + "\t");
			System.out.println();
		}
	}
