package com.yopheu.scanner.models;

/*
 * 클래스의 맴버변수, 맴버 method
 *  	맴버** : 현재의 클래스 scope 내부에 선언된 변수, method
 * 		맴버 변수 : field, 객체변수, 속성, Attribute
 * Dto 클래스의 맴버변수의 접근 제한자
 ...
 * 			현재 프로젝트의 어떤 곳에서든 자유럽게 접근이 가능
 * 		3. private 접근제한자가 잇으면 현재 클래스의 맴버 method 에서만
 * 			접근이 가능하다
 * 
 * Dto 클래스의 맴버 변수와 getter, setter method
 * 		java 의 프로젝트 패턴에서 Dto 클래스의 맴버 변수는 모두 private 선언
...
public class StudentDto {
	 ...
	 * 		맴버변수의 값을 문자열로 만들어서 return 하는 emthod 로
	 *		"재 정의(Override)" 했다.
	 * 	
	 */
	@Override
